...
/* partial_menu.phtml */
class __TwigTemplate_fa985abb55318d2c4029a898205e2b1fad8bcfb40b3aefb08f57967bc324bc2c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "C:\\laragon\\www\\boxbilling/bb-themes\\admin_default\\html/partial_menu.phtml");
    }
}
